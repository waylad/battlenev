...
export interface CarsInterface extends utils.Interface {
  functions: {
    ...
    "randomMint()": FunctionFragment;
    "randomNum()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "randomMint",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "randomNum", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "randomMint", data: BytesLike): Result;
...
export interface Cars extends BaseContract {
  ...
  functions: {
    ...
    getAllOnSale(
      overrides?: CallOverrides
    ): Promise<[Cars.TokenMetaStructOutput[]]>;
    ...
    randomNum(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    randomMint(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    randomNum(overrides?: CallOverrides): Promise<PopulatedTransaction>;
